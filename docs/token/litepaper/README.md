...
Исторически сложилось, что кредитование под залог NFT в сети TON монополизировано. С появлением на рынке кредитования Krediton Lending Tool (подробнее в разделе [Аналитика рынка](market-analysis.md)) монополист не смог ответить ничем, кроме демпинга ставок кредитования. Такая ситуация порождает следующие проблемы:
...
- **Низкая прозрачность**: Монополист не предоставляет достаточно информации о рисках и условиях (закрытые смарт-контракты)[^2].
- **Недостаток инноваций**: В сложившейся ситуации не происходит появление новых DeFi-инструментов, связанных с кредитованием под залог NFT, что, в свою очередь, тормозит развитие экосистемы TON в целом.
...
- **CEO**/**CTO**: Павел.\
  ...
  45 лет, фуллстэк программист (общий опыт в программировании начиная с 1994 года).\
